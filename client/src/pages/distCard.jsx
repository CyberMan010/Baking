...
const DishCardContainer = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .get("http://localhost:3000/api/dishes/getDishes")
      ...
      >
        {dishes.length > 0 ? (
          dishes.map((dish, index) => (
            ...
            >
              <DishCard dish={dish} />
              <button onClick={() => addToCart(dish)} className="rounded-lg relative w-36 h-10 cursor-pointer flex items-center border border-green-500 bg-green-500 group hover:bg-green-500 active:bg-green-500 active:border-green-500">
